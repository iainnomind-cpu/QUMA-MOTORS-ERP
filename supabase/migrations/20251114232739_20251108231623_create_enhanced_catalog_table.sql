/*
  ...
  1. Enhanced Table
    - `catalog` - Complete technical specifications with arrays and enhanced fields
  
  2. Security
    - Enable RLS
    - Public read access, authenticated for management
  
  3. Indexes
    - Optimized for filtering by segment, model, and active status
*/

-- Drop existing catalog table if exists to recreate with enhanced schema
